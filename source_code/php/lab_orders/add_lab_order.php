    ...
    <div class="accountCard" style="float: left; width: 885px; height: 600px; position: relative;">
		...
		<form name="lab_form" action="insert_lab_order.php" onsubmit="return validate_form()" method="post">
			...
			<div style="float: left; margin-left: 250px;">
				...
				<br><br>				                  
								 <input type="checkbox" name="h_pylori_blood" /> <b>H.pylori(Stool)</b>				                 
				<br><br>                               
				...
				<br><br>		 <input type="checkbox" name="hvs" /> <b>HVS</b>
			...
			<div>
				...
				<br><br>
                                 <input type="checkbox" name="arterial_blood_gas" /> <b>Arterial Blood Gas</b>        
				<br><br>
                                 <input type="checkbox" name="liver_function_test" /> <b>Liver Function Test</b>
				<br><br>
                                 <input type="checkbox" name="prothrombin_time" /> <b>Prothrombin Time</b>        
				<br><br>
				                 <input type="checkbox" name="inr" /> <b>INR</b>
				<br><br>
                                 <input type="checkbox" name="thyroid_function_test" /> <b>Thyroid Function Test</b>
				<br><br>
                                 <input type="checkbox" name="cholesterol" /> <b>Cholesterol</b>				 
				<br><br>
                                 <input type="checkbox" name="cardiac_enzymes" /> <b>Cardiac Enzymes</b>
				<br><br>
			...
			<div style="margin-top: 10px;margin-left: 300px;">
				<input style="width: 250px; margin-top: 5px;" type="submit" name="submit_button" class="submitbtn" value="Submit Lab Order">
			</div>
