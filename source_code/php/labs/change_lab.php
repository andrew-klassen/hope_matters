...
<?php
    ...
    <div class="accountCard" style="float: left; width: 885px; height: 2880px; position: relative;">
		...
		<form name="lab_form" action="insert_lab_form.php" onsubmit="return validate_form()" method="post">
			...
			<input type="radio" id="specific_gravity_1.030" name="specific_gravity" value="1.030" disabled />1.030 (Norm 1.006 ֠1.016mg/dL)
			...
			<input type="checkbox" name="gram_stain" onchange="toggle_disabled_gram_stain(this.checked)"/><b>Gram Stain:</b><br> 
                        &nbsp &nbsp &nbsp <textarea rows="6" cols="55" id="gram_stain" name="gram_stain" class="comment_area" maxlength="255" disabled ></textarea> 
			<br> <br>
			<input type="checkbox" name="culture" onchange="toggle_disabled_culture(this.checked)"/><b>Cultures:</b><br> 
                        &nbsp &nbsp &nbsp <textarea rows="6" cols="55" id="culture" name="culture" class="comment_area" maxlength="255" disabled ></textarea> <br> <br>
			...
			&nbsp &nbsp &nbsp &nbsp <input type="text" id="hb_text" name="hb_text" style="width: 200px; height: 30px;" maxlength="30" disabled /> (Norm Men: 13.5 ֠18g/dL, Norm Women: 11.5 ֠16g/dL)
			...
			&nbsp &nbsp &nbsp &nbsp <input type="text" id="mcv_text" name="hb_text" style="width: 200px; height: 30px;" maxlength="30" disabled /> (Norm: 81.2-98.3 fL)
			
			<br>
			
			<label style="margin-left: 50px; margin-right: 10px;">RDW:</label>
			&nbsp &nbsp &nbsp &nbsp<input type="text" id="rdw_text" name="hb_text" style="width: 200px; height: 30px;" maxlength="30" disabled /> (Norm: 11.8%-15.5%)
			
			<br>
			
			 <label style="margin-left: 50px; margin-right: 8px;">WBC:</label>
			&nbsp &nbsp &nbsp &nbsp <input type="text" id="wbc_text" name="hb_text" style="width: 200px; height: 30px;" maxlength="30" disabled /> (Norm: 3.5-10.5 billion cells/L)
		...
		<input type="text" id="neutrophils_text" name="neutrophils_text" style="width: 200px; height: 30px;" maxlength="30" disabled /> ( Norm: 1.7-7.0x10(9)/L )
			...
			<br>
                        ...
                        <input type="text" id="hba1c_text" name="hba1c_text" style="width: 200px; height: 30px;" maxlength="45" disabled /> < 6.0 Normal, 6.0 ֠7.0 Pre-diabetes, >7.0 Diabetes
			...
			<br>			<?php
				echo "<b style=' position: absolute; top: 2840px; left: 400px '>Clinician:</b>
				   <input list='clinician_list' name='clinician' value='$username' style='width: 120px; height:15px;  position: absolute; top: 2840px; left: 475px ' maxlength='20' > <br>
			...
			<div style="position: absolute; top: 2868px; left: 398px;">		
