...
// if the account exists
	...
	if ($package_path_check != 'no_image' and $package_path != 'no_image'){
		rename($package_path_check, '../../../uploaded_images/no_longer_used/ultrasound_images_history/' . substr($package_path_check, strposX($package_path_check, '/', 6) + 1));
	...
	try {
		...
		create_database_error($query, 'update_ultrasound.php (client)', $e->getMessage());
	}
