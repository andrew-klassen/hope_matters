...
# notify user
echo "This update script assumes that you have version 1.04 of the program installed."
...
if [ "$response" = "y" ]; then
	...
	mysql --user=root --password=$password < /var/www/html/update_files/update_1.05/database_change_1.05.sql
