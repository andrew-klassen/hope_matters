...
<body style="padding-top: 70px;">
  ...
  <div id="container">
	  ...
	  <div style="float: left;  width: 300px;">
        <form method="post" action="select_client_referral_form.php">
...
?>
  ...
  <div class="accountCard" style="float: left; height: 245px;">
	...
	<form  name="vital_signs_form" action="insert_referral_form.php" onsubmit="return validate_form()" method="post">
   ...
   <!-- start of bottom card -->
    <div class="accountCard" style="float: left; width: 885px; height: 460px; position: relative;">
		...
		<div style="margin-left: 220px;">
			Refered to: <input type="text" name="referred_to" style="width: 300px; height: 25px;" maxlength="45"><br>
		</div>
		...
		<div style=' float: left; margin-left: 15px; position: relative;'>
			...
			<div style='position: absolute; top: 190px; '>
				Treatment Completed: <br> <textarea style="height: 90px; width: 400px;" name="treatment" class="comment_area" maxlength="255"></textarea><br><br>
			</div>
		...
		<div style=' float: left; margin-left: 470px; position: relative;'>
			...
			<div style='position: absolute; top: 60px; '>
				Reason for Referral/Service Requested: <br> <textarea style="height: 90px; width: 400px;" name="reason_for_referral" class="comment_area" maxlength="255"></textarea><br><br>
			</div>
