...
<body style="padding-top: 70px;">
  ...
  <div id="container">
	  ...
	  <div style="float: left;  width: 300px;">
        <form method="post" action="select_client_treatment_form.php">
...
?>
  ...
  <div class="accountCard" style="float: left; height: 245px;">
	...
	<form  name="vital_signs_form" action="insert_treatment_form_temp.php" onsubmit="return validate_form()" method="post">
		...
		<?php
			...
			echo "<div style=' float: left; padding-left: 15px;'>
						<input type='text' name='t' style='width: 100px; height: 30px;' value='$t' maxlength='10' autofocus onfocus='this.value = this.value;'><br>
	...
	<div style=' float: left; padding-left: 15px;'>
			...
			<?php
				...
				$stmt = $conn->prepare("SELECT COUNT(*) FROM treatment_temp WHERE created_by='$username';");
				$stmt->execute();
				$result = $stmt->setFetchMode(PDO::FETCH_ASSOC);
    ...
    <div class="accountCard" style="float: left; width: 885px; height: 520px; position: relative;">
		...
		<?php
			 echo "<b style=' position: absolute; top: 480px; left: 400px '>Clinician:</b>
				   <input list='clinician_list' name='clinician' value='$username' style='width: 120px; height:15px;  position: absolute; top: 478px; left: 480px ' maxlength='20' > <br>
