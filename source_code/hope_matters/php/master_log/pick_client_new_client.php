...
<div id="container">
	  ...
	  <div style="float: left;  width: 300px;">
        <form method="post" action="master_log_client.php">
            <input style="width: 300px;" type="submit" value="Previous Client">
        </form>
      </div>
...
class view_clients extends RecursiveIteratorIterator {
    ...
    function current() {
		...
		return "<td style='border-style: solid; border-color: #black; background-color: white; color: black;font-weight: 500;font-size: 12px;font-size: 30px;  '>" . "<a href='grab_choosen_client_id.php? choosen_client_id=$temp' style='color: black;'>"  . parent::current() . "</a>" . "</td>";
...
try {
	...
	echo "<p style='color: black;;text-align: center;'>Click on a client to edit their information.</p>";
	...
	<form action='pick_client_new_client.php' method='post' id='searchForm'>
