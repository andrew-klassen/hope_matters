...
$conn->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
	...
	try {
			...
			$query = "INSERT INTO medication_order_dose (medication_order_id, client_id, first_name, last_name, sex, location, date_of_birth, created_by) 
			VALUES ('$choosen_medication_order_id', '$choosen_client_id', '$first_name', '$last_name', '$sex', '$location', '$date_of_birth', '$username');"; 
			$conn->exec($query);
			
			// redirect user back to discharge form selection
			header( 'Location: complete_medication_order.php');
			exit();
		...
		create_database_error($query, 'complete_medication_order.php', $e->getMessage());
	}
