...
class view_clients extends RecursiveIteratorIterator {
    ...
    function current() {
		...
		return "<td style='border-style: solid; border-color: #black; background-color: white; color: black;font-weight: 500;font-size: 12px;font-size: 30px;  '>" . "<a href='grab_choosen_client_id_medication_order_complete.php? choosen_client_id=$temp' style='color: black;'>"  . parent::current() . "</a>" . "</td>";
...
try {
	...
	echo "<p style='color: black;;text-align: center;'>Click on a client to enter a medication order for them.</p>";
	...
	<form action='select_client_medication_order_complete.php' method='post' id='searchForm'>
