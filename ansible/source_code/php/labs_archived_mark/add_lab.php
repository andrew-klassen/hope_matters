...
<?php
    ...
    <div class="accountCard" style="float: left; width: 885px; height: 2780px; position: relative;">
		...
		<form name="lab_form" action="insert_lab_form.php" onsubmit="return validate_form()" method="post">
			...
			<input type="checkbox" name="pbf" onchange="toggle_disabled_inr(this.checked)"/> <b>PBF: </b>
            <input type="text" id="pbf_text" name="pbf_text" style="width: 200px; height: 30px;" maxlength="45" disabled /> 
			...
			<div style="float: left; width: 350px;">
				...
				&nbsp &nbsp TH 1:<input type="number" id="th1" name="th1" style="width: 100px; height: 30px;" maxlength="10" disabled /><br>
				&nbsp &nbsp TH 0:<input type="number" id="th2" name="th2" style="width: 100px; height: 30px;" maxlength="10" disabled />
			</div>
			...
			<div style="float: left; width: 350px;">
				...
				&nbsp &nbsp BM 1:<input type="number" id="bm1" name="bm1" style="width: 100px; height: 30px;" maxlength="10" disabled /><br>
				&nbsp &nbsp BA 1:<input type="number" id="ba1" name="ba1" style="width: 100px; height: 30px;" maxlength="10" disabled />
			</div>
			<br><br><br><br><br>
			...
			&nbsp &nbsp &nbsp APP:<input type="text" id="app" name="app" style="width: 100px; height: 30px;" maxlength="45" disabled /><br>
			&nbsp &nbsp &nbsp MIC:<input type="text" id="mic" name="mic" style="width: 100px; height: 30px;" maxlength="45" disabled />
			...
			&nbsp &nbsp &nbsp Macroscopy:<input type="text" id="macroscopy" name="macroscopy" style="width: 500px; height: 30px;" maxlength="45" disabled /><br>
			&nbsp &nbsp &nbsp Microscopy :<input type="text" id="microscopy_hvs" name="microscopy_hvs" style="width: 500px; height: 30px;" maxlength="45" disabled /> 
			<br>
			<input type="checkbox" name="gram_stain" onchange="toggle_disabled_gram_stain(this.checked)"/><b>Gram Stain:</b><br> 
                        &nbsp &nbsp &nbsp <textarea rows="3" cols="55" id="gram_stain" name="gram_stain_text" class="comment_area" maxlength="255" disabled ></textarea> 
			<br> <br>
			<input type="checkbox" name="culture" onchange="toggle_disabled_culture(this.checked)"/><b>Cultures:</b><br> 
                        &nbsp &nbsp &nbsp <textarea rows="3" cols="55" id="culture" name="culture_text" class="comment_area" maxlength="255" disabled ></textarea> <br> <br>
			...
			<label style="margin-left: 55px;">DU Test:</label><input  type="text" id="du_test" name="du_test" style="width: 200px; height: 30px;" maxlength="45" disabled /><br><br>
			
				
			
			<input type="checkbox" name="blood_count" onchange="toggle_disabled_blood_count(this.checked)"/><b>Blood Counts</b><br>
			
			<label style="margin-left: 50px; margin-right: 18px;">RBC:</label>
			&nbsp &nbsp &nbsp <input type="text" id="rbc" name="rbc" style="width: 200px; height: 30px;" maxlength="30" disabled /> (Norm Men:4.3-5.7 trillion Cells, Norm Women:3.9-5.0 trillion Cells)
			
			<br>
			
			 <label style="margin-left: 50px; margin-right: 22px;">Hb:</label>
			&nbsp &nbsp &nbsp &nbsp <input type="text" id="hb_text" name="hb_text" style="width: 200px; height: 30px;" maxlength="30" disabled /> (Norm Men: 13.5 – 18g/dL, Norm Women: 11.5 – 16g/dL)
			
			<br>
			
			 <label style="margin-left: 50px; margin-right: 18px;">Hct:</label>
			&nbsp &nbsp &nbsp &nbsp <input type="text" id="hct_text" name="hct_text" style="width: 200px; height: 30px;" maxlength="30" disabled />
			
			<br>
			
			<label style="margin-left: 50px; margin-right: 8px;">MCV:</label>
			&nbsp &nbsp &nbsp &nbsp <input type="text" id="mcv_text" name="mcv_text" style="width: 200px; height: 30px;" maxlength="30" disabled /> (Norm: 81.2-98.3 fL)
			
			<br>
			
			<label style="margin-left: 50px; margin-right: 10px;">RDW:</label>
			&nbsp &nbsp &nbsp &nbsp <input type="text" id="rdw_text" name="rdw_text" style="width: 200px; height: 30px;" maxlength="30" disabled /> (Norm: 11.8%-15.5%)
			
			<br>
			
			 <label style="margin-left: 50px; margin-right: 8px;">WBC:</label>
			&nbsp &nbsp &nbsp &nbsp <input type="text" id="wbc_text" name="wbc_text" style="width: 200px; height: 30px;" maxlength="30" disabled /> (Norm: 3.5-10.5 billion cells/L)
			
			<br>
			
			 <label style="margin-left: 50px; margin-right: 14px;">Platelet:</label>
			&nbsp &nbsp <input type="text" id="platelet_text" name="platelet_text" style="width: 200px; height: 30px;" maxlength="30" disabled /> (Norm: 150-450 billion/L)
			
			
			<br>
			
			 <label style="margin-left: 50px; margin-right: 0px;">Neutrophils:</label>
		<input type="text" id="neutrophils_text" name="neutrophils_text" style="width: 200px; height: 30px;" maxlength="30" disabled /> ( Norm: 1.7-7.0x10(9)/L )
			...
			<label style="margin-left: 50px; margin-right: 0px;">Lymphocytes:</label>
			&nbsp <input type="text" id="lymphocytes_text" name="lymphocytes_text" style="width: 200px; height: 30px;" maxlength="30" disabled /> ( Norm: 0.9-2.9x10(9)/L )
			
			<br>
			
			 <label style="margin-left: 50px; margin-right: 21px;">Monocytes:</label>
			...
			<label style="margin-left: 50px; margin-right: 16px;">Eosinophils:</label>
			...
			<br>
			 ...
			 <label style="margin-left: 50px; margin-right: 29px;">Basophils:</label>
			...
			<br>
			 ...
			 <label style="margin-left: 50px; margin-right: 16px;">Calcium:</label>
			...
			<label style="margin-left: 50px; margin-right: 35px;">Bicarbonate:</label>
			...
			<label style="margin-left: 50px; margin-right: 0px;">Creatinine: </label>
			...
			<br>
                        ...
                        <label style="margin-left: 50px; margin-right: 22px;">HbA1C:</label>
			...
			<br>
			 ...
			 <label style="margin-left: 50px; margin-right: 12px;">PaCO2:</label>
			<input type="text" id="paco2" name="paco2" style="width: 200px; height: 30px;" maxlength="30" disabled /> (Norm: 98-107 mmol/L)
			
			<br>
			
			<label style="margin-left: 50px; margin-right: 0px;">Arterial Blood pH:</label>
			...
			<br>
			 ...
			 <label style="margin-left: 50px; margin-right: 18px;">HCO3:</label>
			<input type="text" id="hco3_text" name="hco3_text" style="width: 200px; height: 30px;" maxlength="30" disabled /> (Norm: 22-28 mEq/L)
			
			<br>	
		   
			
			<input type="checkbox" name="liver_function_test" onchange="toggle_disabled_blood_gas(this.checked)"/><b>Liver Function Test</b><br>
			
			<label style="margin-left: 50px; margin-right: 33px;">ALT:</label>
			<input type="text" id="alt" name="alt" style="width: 200px; height: 30px;" maxlength="30" disabled /> (Norm: 7-55 U/L)
			
			<br>
			
			 <label style="margin-left: 50px; margin-right: 30px;">AST:</label>
			<input type="text" id="ast" name="ast_text" style="width: 200px; height: 30px;" maxlength="30" disabled /> (Norm: 8-48 U/L)
			
			<br>
			
			<label style="margin-left: 50px; margin-right: 0px;">Albumin:</label>
			...
			<label style="margin-left: 50px; margin-right: 46px;">TSH:</label>
			...
			<input type="checkbox" name="cholesterol" onchange="toggle_disabled_cholesterol(this.checked)"/><b>Cholesterol</b><br>
			
			<label style="margin-left: 50px; margin-right: 20px;">Total:</label>
			<input type="text" id="total" name="total" style="width: 180px; height: 30px;" maxlength="30" disabled /> (Norm<200mg/dL, Brorderline 200-239 mg/dL, High>240 mg/dL )
			
			<br>
			
			 <label style="margin-left: 50px; margin-right: 22px;">HDL:</label>
			<input type="text" id="hdl" name="hdl_text" style="width: 180px; height: 30px;" maxlength="30" disabled /> (Norm Male>40mg/dL, Female>50mg/dL)
			
			<br>
			
			<label style="margin-left: 50px; margin-right: 25px;">LDL:</label>
			<input type="text" id="ldl_text" name="ldl_text" style="width: 180px; height: 30px;" maxlength="30" disabled /> (Norm <100mg/dL, Borderline 130-159 mg/dL, High 160-189 mg/dL, V.High>190)
			...
			<label style="margin-left: 50px; margin-right: 0px;">Troponin:</label>
			<input type="text" id="troponin" name="troponin" style="width: 200px; height: 30px;" maxlength="30" disabled /> (Norm <0.04 ng/mL )
			
			<br>
			
			<label style="margin-left: 50px; margin-right: 0px;">CK:</label>
			<input type="text" id="ck" name="ck_text" style="width: 200px; height: 30px;margin-left: 40px;" maxlength="30" disabled /> (Norm Male 39-308 U/L, Female 26-192 U/L)
			
			<br>			<div style="position: absolute; top: 2750px; left: 315px;">	<?php
			...
			<div style="position: absolute; top: 2780px; left: 398px;">		
