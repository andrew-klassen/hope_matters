...
// if the account exists
	...
	if ($image_path_check != 'no_image' and $image_path != 'no_image'){
		rename($image_path_check, '../../uploaded_images/no_longer_used/dental_images_history/' . substr($image_path_check, strposX($image_path_check, '/', 5) + 1));
	...
	try {
	    ...
	    header( 'Location: select_dental_form.php');
		exit();

	}

	catch(PDOException $e) {
		create_database_error($query, 'update_dental_form.php', $e->getMessage());	
	}
