...
class view_clients extends RecursiveIteratorIterator {
    ...
    function current() {
		...
		return "<td style='border-style: solid; border-color: #black; background-color: white; color: black;font-weight: 500;font-size: 12px;font-size: 30px;  '>" . "<a href='grab_choosen_medication_order_id_complete.php? choosen_medication_order_id=$temp' style='color: black;'>"  . parent::current() . "</a>" . "</td>";
...
try {
	...
	if ($order_type == "no") {
		echo "<div >
		<form action='select_medication_order_complete.php' method='post' id='searchForm'>
