...
// make sure image is acceptible before continuing
	if ($package_path = upload_package('ultrasound_images', 'Ultrasound Images', '../view_all_form.php', '../../../uploaded_images/in_use/ultrasound_images/')) {
	...
	try {
		...
		create_database_error($query, 'insert_ultrasound.php (client)', $e->getMessage());	
	}
