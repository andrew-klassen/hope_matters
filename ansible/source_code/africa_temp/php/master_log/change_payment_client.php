...
<div id='container'>
	...
	<div style="float: left;  width: 300px;">
		<form method="post" action="master_log_client.php">
			<input style="width: 300px;" type="submit" value="Back to Client">
		</form>
	</div>
...
?>
 ...
 <div class='accountCard'>
				...
				<form  name='client_form' action='update_payment_client.php' onsubmit='return validate_form()' method='post'>
