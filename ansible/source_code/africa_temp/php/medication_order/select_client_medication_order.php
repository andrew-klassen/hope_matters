...
class view_clients extends RecursiveIteratorIterator {
    ...
    function current() {
		...
		return "<td style='border-style: solid; border-color: #black; background-color: white; color: black;font-weight: 500;font-size: 12px;font-size: 30px;  '>" . "<a href='grab_choosen_client_id_medication_order.php? choosen_client_id=$temp' style='color: black;'>"  . parent::current() . "</a>" . "</td>";
...
try {
	...
	<form action='select_client_medication_order.php' method='post' id='searchForm'>
